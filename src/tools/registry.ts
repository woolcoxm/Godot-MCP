...
export class ToolRegistry {
  ...
  // ⚡ Bolt Optimization: O(1) cache for category lookups instead of O(N) array filtering.
  // This speeds up read-heavy operations like `godot_list_tools` and `getToolsByCategory`.
